...
import { BMI } from '../blocks/BmiCalculator/Config';
import { Type as BmiType } from '../blocks/BmiCalculator/Component'
export type Layout = CallToActionType | ContentType | ImageType | BmiType
